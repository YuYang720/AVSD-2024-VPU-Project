...
int main() {
    ...
    imatmul_4x4((int32_t *)s0, (int32_t *)H, (int32_t *)i, 4, 4, 1);
    imatmul_4x4((int32_t *)s1, (int32_t *)test_matrix, (int32_t *)s0, 4, 4, 1);
    // imaxmul((int32_t *)s2, (int32_t *)IxX, (int32_t *)s1, 4, 4, 1);
    imatmul_4x4((int32_t *)_test_start, (int32_t *)Hq0, (int32_t *)s1, 4, 4, 1);
